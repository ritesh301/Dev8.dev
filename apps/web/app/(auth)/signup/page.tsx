      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">Start coding in the cloud in seconds</p>
          </div>

          <Card className="border-border/50 bg-card/50 backdrop-blur">
            <CardHeader className="space-y-1 text-center">
              <CardTitle className="text-2xl">Sign Up</CardTitle>
              <CardDescription>Create your Dev8.dev account to get started</CardDescription>
            </CardHeader>
            <CardContent>
              {error && (
              ...
              {success && (
                <div className="mb-4 rounded-md border border-green-500/50 bg-green-500/10 p-3">
